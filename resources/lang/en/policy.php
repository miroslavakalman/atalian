...
return [
    ...
    'basic_concepts' => '2. BASIC CONCEPTS',
    'personal_data' => 'Personal data',
    'personal_data_def' => 'any information relating to directly or indirectly identified or identifiable natural person (personal data subject);',
    'processing' => 'Processing of personal data',
    'processing_def' => 'any action (operation) or set of actions (operations) performed with personal data using automation tools or without using such tools, including collection, recording, systematization, accumulation, storage, clarification (update, change), retrieval, use, transfer (distribution, provision, access), depersonalization, blocking, deletion, destruction of personal data;',
    'operator' => 'Operator',
    'operator_def' => 'a state body, municipal body, legal entity or individual that independently or jointly with other persons organizes and (or) carries out the processing of personal data, as well as determines the purposes of processing personal data, the composition of personal data to be processed, actions (operations) performed with personal data;',
    'subject' => 'Personal data subject',
    'subject_def' => 'a natural person to whom personal data relates;',
    
    'processing_purposes' => '3. PURPOSES OF PERSONAL DATA PROCESSING',
    'purposes_list' => [
    ...
    'legal_basis' => '4. LEGAL BASIS FOR PROCESSING PERSONAL DATA',
    'legal_basis_text' => '4.1. The legal grounds for processing personal data by the Operator are:<br>
    • Federal Law No. 152-FZ dated July 27, 2006 "On Personal Data";<br>
    • Charter documents of the Operator;<br>
    • Contracts concluded between the Operator and the personal data subject;<br>
    • Consent of personal data subjects to the processing of their personal data.',
    
    'data_categories' => '5. CATEGORIES OF PERSONAL DATA PROCESSED',
    'clients_data' => '<strong>For clients and partners:</strong>',
    'clients_list' => [
    ...
    'candidates_data' => '<strong>For job applicants:</strong>',
    'candidates_list' => [
        'Last name, first name, patronymic;',
        'Contact details;',
    ...
    'visitors_data' => '<strong>For website visitors:</strong>',
    'visitors_list' => [
        'IP address;',
        'Cookie data;',
    ...
    'processing_principles' => '6. PRINCIPLES OF PERSONAL DATA PROCESSING',
    'principles_list' => [
    ...
    'processing_conditions' => '7. CONDITIONS FOR PROCESSING PERSONAL DATA',
    'conditions_list' => [
    ...
    'storage_period' => '8. PERSONAL DATA RETENTION PERIODS',
    'storage_text' => '8.1. Personal data retention periods are determined in accordance with the following criteria:<br>
    • For clients — within 5 years from the termination of contractual relations, but not less than the periods established by accounting and tax legislation;<br>
    • For applicants — within 3 years from the receipt of the resume;<br>
    • For website visitors — within 1 year from the last visit;<br>
    • If there are separate consents of the subjects — within the validity period of the consent.<br><br>
    8.2. Upon expiration of the specified periods, personal data are subject to destruction or depersonalization.',
    
    'security_measures' => '9. MEASURES TO ENSURE THE SECURITY OF PERSONAL DATA',
    'security_list' => [
    ...
    'rights_of_subjects' => '10. RIGHTS OF PERSONAL DATA SUBJECTS',
    'rights_list' => [
    ...
    'cross_border_transfer' => '11. INTERNATIONAL TRANSFER OF PERSONAL DATA',
    'cross_border_text' => '11.1. Before starting the cross-border transfer of personal data, the Operator is obliged to ensure that the foreign state to whose territory it is intended to transfer personal data provides adequate protection of the rights of personal data subjects.<br>
    ...
    'final_provisions' => '12. FINAL PROVISIONS',
    'final_provisions_text' => '12.1. This Policy is a publicly available document and must be posted on the official website of the Operator.<br>
    12.2. The Operator has the right to make changes to this Policy. When changes are made, the date of the last update is indicated in the current version.<br>
    12.3. The new version of the Policy comes into force from the moment it is posted on the website, unless otherwise provided by the new version of the Policy.<br>
    12.4. All suggestions or questions regarding this Policy should be sent to the email address: :email.<br>
    12.5. The current version of the Policy is available on the website at: :policy_url.',
    
    'contacts' => 'CONTACT INFORMATION',
    'contacts_text' => 'LLC "ATALIAN GLOBAL SERVICES"<br>
    TIN 7707374691 / TRC 771401001<br>
    PSRN 5167746274944<br>
    Legal address: 125040, Moscow, Skakovaya str., 36, floor 1, premises XIII, room 102a<br>
    Email: :email<br>
    Phone: +7 (495) 411-56-45'
];