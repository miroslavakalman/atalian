<div class="services wrapper" id="wrapper-adv">
    ...
    <div class="dropdown-item">
        <div class="dropdown-closed">
            ...
            <img src="img/icons/arrow.webp" class="arrow-down" alt="<?php echo e(__('messages.arrow_down_alt')); ?>">
        </div>
        <div class="dropdown-opened">
            <div class="dropdown-opened-row">
                <p class="secondary-p-white"><?php echo $service['title']; ?></p>
                <img src="img/icons/arrow-up.webp" class="arrow-up" alt="<?php echo e(__('messages.arrow_up_alt')); ?>">
            </div>
